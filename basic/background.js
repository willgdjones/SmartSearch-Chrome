...
var DataStore = (function ()
{
    ...
    o.AddPage = function ( tabId, pageUrl, transitionType )
    {
        console.log( 'addPage( ' + tabId + ', ' + pageUrl + ', ' + transitionType + ' )' );
        ...
        {
            parentPageId = tabUrls[ tabId ] ? parseInt( tabUrls[ tabId ] ) : 0;
        }
...
chrome.webNavigation.onCommitted.addListener
    (
        function ( details )
        {
            ...
            {
                DataStore.AddPage( o.activeTabID, details.url, details.transitionType );
            }
        },
        {urls:["*://*/*"]},
        ["responseHeaders"]
