...
var DataStore = (function ()
{
    ...
    o.AddPage = function ( pageUrl, transitionType )
    {
        console.log( 'addPage( ' + pageUrl + ', ' + transitionType + ' )' );
        ...
        {
            parentPageId = tabUrls[ o.activeTabID ] ? parseInt( tabUrls[ o.activeTabID ] ) : 0;
        }
